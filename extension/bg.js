...
chrome.runtime.onInstalled.addListener(function() {
	chrome.storage.local.set({interleavingTrigger: 2, lastDeck:"", interleavingDisabled:false, betaEnabled:false, deckNames:{}, excludedDecks:[]}, function() {}); //Set default values
});
